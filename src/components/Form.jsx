        ...
        <p className="font-medium text-lg text-gray-500 mt-4">Please enter your details</p>
            <div className="mt-8">
                ...
                <div>
                    ...
                    <input type="password" className="w-full border-2 border-gray-100 rounded-xl p-4 mt-1 bg-transparent" placeholder="Enter your email"/>
                </div>
                <div>
                ...
                <div className="mt-8 flex flex-col gap-y-4">
                    <button className=" text-lg font-semibold active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all w-full bg-violet-500 text-white p-4 rounded-xl">Sign in</button>
